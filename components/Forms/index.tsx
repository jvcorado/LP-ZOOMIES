  ...
  return (
    <>
      <form onSubmit={handleSubmit} method="post" className=" flex flex-col w-full lg:w-4/12 gap-3 p-10  shadow-2xl rounded-2xl bg-white">
        ...
        <p className="text-center" style={{color:"#587EBF"}}>Se ainda não, increva-se agora mesmo!</p>
        ...
        <label htmlFor="instagram" className="text-xl">Instagram:</label>
        <input
          type="text"
          id="instagram"
          name="instagram"
        ...
        <label htmlFor="curriculo" className="text-xl">Curriculo:</label>
        <input
          type="file"
          id="curriculo"
          name="curriculo"
        ...
        <button type="submit" className="px-4 py-2 lg:py-4 rounded-md text-white" style={{backgroundColor:'#587EBF'}}>Insrever-se</button>
      </form>
    </>
  );
};
